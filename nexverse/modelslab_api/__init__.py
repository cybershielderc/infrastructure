...
class TextToImage:
    DEFAULT_NEG_PROMPT: str = "lowres, text, error, cropped, worst quality, low quality, jpeg artifacts, ugly, duplicate, morbid, mutilated, out of frame, extra fingers, mutated hands, poorly drawn hands, poorly drawn face, mutation, deformed, blurry, dehydrated, bad anatomy, bad proportions, extra limbs, cloned face, disfigured, gross proportions, malformed limbs, missing arms, missing legs, extra arms, extra legs, fused fingers, too many fingers, long neck, username, watermark, artist signature, signature",
            ...
            if response[0] is 200:
                ...
                if response[1]['status'] == 'success':
                    ...
                    if len(response[1]['output']) is not 1:
                        ...
                        queue_status_codes = [True if requests.head(x).status_code == 200 else False for x in
                                              response[1]['output']]
                        ...
                        queue_status_code = requests.head(
                    ...
                    return [
                        response[1]['id'],  # Image ID
                        response[1]['future_links'][0] if len(response[1]['future_links']) == 1 else response[1][
                            'future_links'],
