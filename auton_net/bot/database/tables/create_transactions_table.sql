...
(
    ...
    `sender_wallet`         TEXT(256) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT '0xdead',
    `receiver_wallet`       TEXT(256) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT '0xdead',
